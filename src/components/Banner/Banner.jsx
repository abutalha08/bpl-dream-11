...
const Banner = () => {
    return (
        <div className='max-w-10/12 mx-auto'>
            <div
                className="bg-cover bg-center rounded-lg relative overflow-hidden bg-[#0a0a0a]"
            ...
            >
                ...
                <div className="relative z-10 flex h-full py-10 items-center justify-center">
                   ...
                   <div className='space-y-5 text-center'>
                    ...
                    <p className='text-[24px] font-medium text-base-200'>Beyond Boundaries Beyond Limits</p>
